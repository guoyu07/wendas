...
class TagLibWego extends TagLib{
     ...
     * @return string|void
     ...
     public function _calendar($attr,$content){     	
        ...
        $parseStr=''.$link.'
		<input class="date input-text" type="text" name="'.$name.'" id="'.$name.'" size="12" value="'.$content.'" />	
     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            case 'UBB':
                ...
                break;
            case 'KINDEDITOR':                
                $parseStr='<script type="text/javascript" src="__ROOT__/include/Kindeditor/kindeditor.js"></script><script type="text/javascript" src="__ROOT__/include/Kindeditor/lang/zh_CN.js"></script><script> var editor; KindEditor.ready(function(K) { editor = K.create(\'#'.$id.'\');});</script><textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" >'.$content.'</textarea>';
                break;
            default :
