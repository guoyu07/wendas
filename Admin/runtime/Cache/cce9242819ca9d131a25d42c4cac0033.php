...
</script><div style="padding:10px; overflow:hidden;"><div class="main_top" style="clear:both;"><?php if($no_security_info == 1): ?><h4>安全提示</h4><!-- <?php if(is_array($security_info)): $i = 0; $__LIST__ = $security_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p class="red" style="font-size:14px;">※　<?php echo ($v); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>	 --><?php endif; ?><h4>网站无法显示</h4><p class="green">网站以前正常显示，现在无法显示请清除缓存试试，【<a href="<?php echo u('cache/index');?>"><?php echo (L("flush_cache")); ?></a>】</p></div><div style="width:50%;" class="fl"><div class="main_con fl"><h6>服务器信息</h6><div class="content"><?php if(is_array($server_info)): $i = 0; $__LIST__ = $server_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><?php echo ($key); ?> : <?php echo ($v); ?></p><?php endforeach; endif; else: echo "" ;endif; ?><div class="hr"></div></div></div></div><div style="width:49%;" class="fr"><div class="main_con fl"><h6>版权信息</h6><div class="content"><p>开发与支持团队：chaimao</p><p>UI/美工设计：chaimao</p><div class="hr"></div><!-- <p>官方论坛：<a href="http://bbs.wego360.com" target="_blank">bbs.wego360.com</a></p> --></div></div></div></div></body></html>